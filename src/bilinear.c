 ...
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_8bilinear_DTYPE_float32_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
static PyTypeObject *__pyx_ptype_8bilinear_ndarray = 0;
static PyTypeObject *__pyx_ptype_8bilinear_bilinear = 0;
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_8bilinear_DTYPE_float32_t = { "DTYPE_float32_t", NULL, sizeof(__pyx_t_8bilinear_DTYPE_float32_t), 'R', 0, 0 };
#define __Pyx_MODULE_NAME "bilinear"
int __pyx_module_is_main_bilinear = 0;
...
static char __pyx_k_14[] = "Jerome Kieffer";
static char __pyx_k_15[] = "21/12/2011";
static char __pyx_k_16[] = "2011, ESRF";
...
static void __pyx_tp_dealloc_8bilinear_bilinear(PyObject *o) {
  {
    ...
    ++Py_REFCNT(o);
    __pyx_pf_8bilinear_8bilinear___dealloc__(o);
...
static PyMethodDef __pyx_methods_8bilinear_bilinear[] = {
  {__Pyx_NAMESTR("f_cy"), (PyCFunction)__pyx_pf_8bilinear_8bilinear_2f_cy, METH_O, __Pyx_DOCSTR(__pyx_doc_8bilinear_8bilinear_2f_cy)},
  {0, 0, 0, 0}
};
...
static PyTypeObject __pyx_type_8bilinear_bilinear = {
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pf_8bilinear_8bilinear_1__init__, /*tp_init*/
  0, /*tp_alloc*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_bilinear(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("bilinear"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /*--- Type init code ---*/
  __pyx_ptype_8bilinear_ndarray = __Pyx_ImportType("numpy", "ndarray", sizeof(PyArrayObject), 0); if (unlikely(!__pyx_ptype_8bilinear_ndarray)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (PyType_Ready(&__pyx_type_8bilinear_bilinear) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "bilinear", (PyObject *)&__pyx_type_8bilinear_bilinear) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_ImportError, "init bilinear");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
